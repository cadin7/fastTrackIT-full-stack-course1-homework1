...
public class Product {
    ...
    public boolean equals(Object o) {
        ...
        return price == product.price && Objects.equals(name, product.name) && Objects.equals(categories,
                product.categories)
    ...
    static class ProductBuilder {
        ...
        public ProductBuilder categories(Category category) {
        ...
        public Product build() {
            return new Product(name, price, new ArrayList<>(categories), description);
        }
    }
}
